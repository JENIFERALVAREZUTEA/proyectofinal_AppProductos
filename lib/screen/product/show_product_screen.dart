                            ...
                            if (direction == DismissDirection.startToEnd) {
                              ...
                              navigatorPushWidget(
                                ...
                                EditProductScreen(
                                  ...
                                  productDescription: helperVar.productDescription,
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            '¿Quieres eliminar  ${helper.productName}?',
            maxLines: 2,
            style: Responsive.isMobile(context)
              ...
              Expanded(
                child: SmallRedElevationButton(
                  ...
                  onPress: () async {
                    ...
                    snackBarSuccessWidget(context, 'Producto eliminado');
          ...
          children: [
            Flexible(
              child: Column(
                ...
                mainAxisAlignment: MainAxisAlignment.spaceAround,
                children: [
                  getBodyBoldText(context, '', helper.productName,),
                  getBodyBoldText(context, 'Material:', helper.productDescription,),
                  SizedBox(height: height * 0.02),
                  getPriceText(context, 's/. ', helper.productPrice),
                ],
              ),
            ),
            Row(
