...
import 'package:app_productos/widget/navigator/navigator.dart';
                      ...
                      if (productProvider.image != null) {
                        if (productProvider.fileType != 'png' &&
                          ...
                          if (double.parse(productProvider.fileSize.toString()) >=
                            ...
                            productProvider.updateProductDescriptionById(
                              helperVar.id,
                              _descriptionController.text,
                            );
                            item.productDescription = _descriptionController.text;
                            ...
                            snackBarSuccessWidget(context, 'producto editado');
